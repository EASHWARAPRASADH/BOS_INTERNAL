...
CREATE INDEX IF NOT EXISTS idx_mua_schedule_id ON qms_meeting_user_attendance(schedule_id);
CREATE INDEX IF NOT EXISTS idx_mua_employee_id ON qms_meeting_user_attendance(employee_id);
CREATE INDEX IF NOT EXISTS idx_mom_detail_status ON qms_mom_detail(status);
CREATE INDEX IF NOT EXISTS idx_meeting_schedule_status ON qms_meeting_schedule(status);
CREATE INDEX IF NOT EXISTS idx_meeting_schedule_date ON qms_meeting_schedule(meeting_date);
